        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/admin" class="app-brand-link">
              ...
              <img src="/backend/assets/img/badre-logo.png" style="width: 100%;" alt="logo" srcset="">
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            {{-- <li class="menu-item active">
              <a href="/admin" class="menu-link">
                <i class='menu-icon tf-icons bx bx-home-smile bx-tada' ></i>
                <div data-i18n="Analytics">Dashboard</div>
              </a>
            </li> --}}
            <li class="menu-item ">
              <a href="{{ route("maison.index") }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="gestion maisons">maison</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="{{ route("vendeur.index") }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-key"></i>
                <div data-i18n="gestion Clients Vendeur">Client Vendeur</div>
              </a>
            </li>
            <li class="menu-item ">
              <a href="{{ route("consommateur.index") }}" class="menu-link">
                <i class='menu-icon tf-icons bx bx-user'></i>
                <div data-i18n="gestion Clients Consommateur">Client Consommateur</div>
              </a>
            </li>
            <li class="menu-item ">
              <a href="{{ route("louer.index") }}" class="menu-link">
                <i class='menu-icon tf-icons bx bx-transfer' ></i>
                <div data-i18n="gestion Louers">Louer</div>
              </a>
            </li>
            <li class="menu-item ">
