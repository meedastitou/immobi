...
@section('main')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
          <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Consommateur /</span> Ajouter Consommateur</h4>
          <div class="row">  
            <div class="col-xl-7 col-md-12 col-sm-12">
              <!-- HTML5 Inputs -->
              <div class="card mb-4">
                <h5 class="card-header">Ajouter Consommateur</h5>
                <div class="card-body">
                  <form action="{{ route('storeConsommateur.store') }}" method="post">
                    @csrf
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                      <label for="nb_personne" class="col-md-3 form-label">Nombre Personnes</label>
                      <div class="col-md-9">
                        <input type="number" name="nb_personne" class="form-control" id="nb_personne" placeholder="Entrez nombre des personnes"/>
                      </div>
                    </div>  
                    <div class="mt-2">
